// encontrar o botao de adicionar tarefa
...
function ocultarExibirFormTarefas() {
...
const removerTarefas = (apenasCompletas) => {
    ...
    tarefas = apenasCompletas ? tarefas.filter(elemento => !elemento.completa) : []
    atualizarTarefas()
}

btnRemoverConcluidas.addEventListener('click', () => removerTarefas(true))
btnRemoverTarefas.addEventListener('click', () => removerTarefas(false))