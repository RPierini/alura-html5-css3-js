...
const imagemStartPauseBt = document.querySelector('#start-pause img');
...
function alterarContexto (contexto) {
    ...
    switch (contexto) {
        ...
        case 'descanso-curto':
            ...
            break;
        case 'descanso-longo':
                titulo.innerHTML = `Hora de voltar à superfície, <strong class="app__title-strong">mergulhe no que importa.</strong>`;
...
function iniciarOuPausar() {
    if (intervaloId) {
        textoStartPauseBt.textContent = 'Continuar';
        imagemStartPauseBt.setAttribute('src', 'imagens/play_arrow.png')
        somPause.play();
        zerar();
        return;
